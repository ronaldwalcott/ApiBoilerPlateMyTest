...
using ApiBoilerPlateMyTest.Infrastructure.Extensions;
...
namespace ApiBoilerPlateMyTest
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "ApiBoilerPlateMyTest ASP.NET Core API v1");
            });
...
//Syncfusion grid does not work with APIs that use exception wrapping with OData EDM model
//So the below line has been commented out
        ...
        private IEdmModel GetEdmModel()
        {
            ...
            odataBuilder.EntitySet<PersonResponse>("Persons");
